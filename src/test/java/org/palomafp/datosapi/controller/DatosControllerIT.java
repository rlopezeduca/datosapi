 ...
 * Estas pruebas verifican el comportamiento del controlador en conjunto con la lógica de negocio y el DAO.
 */
class DatosControllerIT {
	...
	@BeforeEach
	void setUp() {
        // MockMvc permite probar el controlador 'DatosController' sin necesidad de arrancar el servidor completo
